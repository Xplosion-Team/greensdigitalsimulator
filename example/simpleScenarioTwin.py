...
fig.suptitle('Interactive T1D Digital Twin - Simple Scenario Creator', fontsize=16, fontweight='bold')

# Create subplots with different sizes
ax_main = plt.subplot2grid((5, 4), (0, 0), colspan=3, rowspan=3)  # Main plot
ax_control = plt.subplot2grid((5, 4), (3, 0), colspan=4, rowspan=1)  # Control panel
ax_scenario = plt.subplot2grid((5, 4), (0, 3), rowspan=2)  # Scenario panel
ax_params = plt.subplot2grid((5, 4), (2, 3), rowspan=1)  # Parameter panel
...
# Function to create simple scenario
def create_simple_scenario():
    ...
    # Create time array
    base_date = datetime.datetime(2024, 8, 15, 8, 0, 0)  # Start at 8 AM
...
# Create animation
print("Creating simple scenario-based interactive animation... This may take a moment...")
...
# Show the animation
print("Simple scenario-based interactive animation ready!")
print("Controls:")
